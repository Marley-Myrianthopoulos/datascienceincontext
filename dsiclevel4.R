...
csv_pathway <- paste("/Users/marleymyrianthopoulos/Desktop/Attendance Presentation/Level 4/Week ", week_number, "/attendance_week_", week_number, ".csv", sep = "")
...
write_pathway <- paste("/Users/marleymyrianthopoulos/Desktop/Attendance Presentation/Level 4/Week ", week_number, sep = "")

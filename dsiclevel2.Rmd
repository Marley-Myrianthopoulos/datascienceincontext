...
```{r}
raw_data <- read.csv("/Users/marleymyrianthopoulos/Desktop/Attendance Presentation/Level 2/Week _/attendance_week__.csv")
...
write.csv(late_students, "/Users/marleymyrianthopoulos/Desktop/Attendance Presentation/Level 2/Week _/late_students.csv", row.names = FALSE)
write.csv(days_missed, "/Users/marleymyrianthopoulos/Desktop/Attendance Presentation/Level 2/Week _/days_missed.csv", row.names = FALSE)
write.csv(perfect_attendance, "/Users/marleymyrianthopoulos/Desktop/Attendance Presentation/Level 2/Week _/perfect_attendance.csv", row.names = FALSE)
```
